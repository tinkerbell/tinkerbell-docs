...
source and you can find it as part of
...
page](https://github.com/tinkerbell/sandbox/releases) the retrieve it in the format you need.
...
hardware and template. Or to fetch and filter those resources.
